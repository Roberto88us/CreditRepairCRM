...
def load_client_workspace_context(cur, client_id: str, reveal_cred_id: Optional[str] = None):
    ...
    return dashboard, profile, score_groups, credentials, notes, appointments, referral_partners
...
def render_client_workspace(request: Request, client_id: str, message: str = "", error: str = "", reveal_cred_id: Optional[str] = None):
    ...
    try:
        with conn.cursor() as cur:
            dashboard, profile, score_groups, credentials, notes, appointments, referral_partners = load_client_workspace_context(cur, client_id, reveal_cred_id)
        if not profile:
